...
export const PALETTE_FILES = [
  ...
  { name: '16colors: LostCentury', path: 'Colors/16colors_Lost_Century.png' },
  { name: '16colors: GalaxyFlame', path: 'Colors/16colors_Galaxy_Flame.png' },
  { name: '16colors: PastelPop', path: 'Colors/16colors_Pastel_Pop.png' },
